...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col justify-center items-center px-4 py-6">
      <div className="max-w-4xl w-full">
        <div className="flex flex-col items-center mb-8">
          ...
          <div className="flex justify-center gap-4 mb-10 w-full">
            <div className="bg-[#11609C] text-white rounded p-3 w-20 text-center">
        ...
        <div className="mb-8">
          ...
          <div className="bg-[#f8f9fa] p-5 rounded-lg">
            ...
            <ul className="text-[#7fa6c3] space-y-2 mx-auto max-w-2xl">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-6">
          <a href="https://pf.kakao.com/_pGxkPn/chat" 
             className="bg-red-600 text-white font-bold px-5 py-2 rounded-full hover:bg-red-700 transition-colors text-sm">
            카카오톡 상담하기
          </a>
        ...
        <div className="text-center text-[#7fa6c3] text-xs">
